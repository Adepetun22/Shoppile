...
const MobileNav = () => {
  ...
  return (
    <div className="sticky top-0 z-50">
      ...
      <div className="flex flex-col gap-2 items-center justify-center w-full px-8 py-2 bg-yellow-100 md:bg-red-100">
          ...
          {showMenu && (
            <div className="bg-white border border-gray-200 rounded-lg p-4 w-full">
              <div className="flex flex-col gap-4">
                {/* On Sale */}
                <Link to="/category?category=On Sale" onClick={closeMenu} className="text-sm xs:text-xs sm:text-sm text-black">On Sale</Link>
                {/* New Arrivals */}
                <Link to="/category?category=New Arrivals" onClick={closeMenu} className="text-sm xs:text-xs sm:text-sm text-black">New Arrivals</Link>
                {/* Brands */}
                <Link to="/category?category=Brands" onClick={closeMenu} className="text-sm xs:text-xs sm:text-sm text-black">Brands</Link>
                {/* Profile */}
                <Link to="/profile" onClick={closeMenu} className="flex items-center cursor-pointer pt-2 border-t border-gray-200">
                  <img
                    className="w-6 h-6"
